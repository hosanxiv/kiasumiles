...
def test_landing_copy_is_truthful_and_accessible():
    ...
    required_copy = (
        ...
        "Copy this prompt",
        "Use KiasuMiles. If its tools are already available, reuse them.",
        "KiasuMiles ONLY works with AI assistants that can use external tools.",
        ...
        "New Plugin",
        "No Auth",
        "chatgpt-custom-connector.png",
        "Add custom connector",
        "Tested in Claude chat and Cowork on desktop; mobile availability may vary.",
        "max-height: 280px",
        "View setup screenshot (opens in a new tab)",
        "Can I use it on my phone?",
        "Do I need to wait for a public plugin?",
        "claude-custom-connector.png",
