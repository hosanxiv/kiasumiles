...
class CardRule:
    ...
    requires_amaze: bool
    amaze_fee_pct: float
    eligible_merchants: list[str]  # if set, bonus rate only applies at these merchants
    eligible_channels: list[str]  # if set, bonus rate only applies for these merchant channels
    caveat: str
    last_verified: str
    source_url: str
